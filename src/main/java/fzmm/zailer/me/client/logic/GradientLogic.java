...
//
//public record GradientLogic(String detailsId, boolean obfuscated, boolean bold, boolean strikethrough, boolean underline, boolean italic) {
//
...
//        int messageLength = this.detailsId.length();
...
//
//        for (int i = 0; i != this.detailsId.length(); i++)
...
//        return Arrays.asList(this.detailsId.split("(?s)(?<=\\G.{1," + GradientScreen.MAX_MESSAGE_LENGTH + "})"));
//    }
//
//}
