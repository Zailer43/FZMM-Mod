...
public class MchTier {
    ...
    protected MchTier(Text message, int permissions) {
    ...
    static {
        ...
        INVALID_LICENSE = builder()
                .message(
                        Text.translatable(translation + "invalid")
                                .setStyle(Style.EMPTY.withColor(Formatting.RED).withBold(true))
                )
                .build();
        NO_LICENSE = builder()
                .message(
                        Text.translatable(translation + "no_license")
        ...
        FREE = builderOf(NO_LICENSE)
                .message(
                        Text.translatable(translation + "free")
        ...
        GOLD = builderOf(SILVER)
                .message(
                        Text.translatable(translation + "gold")
    ...
    private final static class Builder {
        ...
        private Builder message(Text text) {
            this.message = text;
            return this;
        }
