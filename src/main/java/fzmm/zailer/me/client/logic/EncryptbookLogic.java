...
//    }
//
//    public static void give(final int SEED, String detailsId, final String AUTHOR, final String PADDING_CHARS, final int MAX_MESSAGE_LENGTH, String bookTitle) {
//		/*
//		{
...
//					&9Key: &0secret_mc_1\\n
//					&9Asymmetric: &0true\\n
//					&9Encrypted detailsId: &0Hover over here"
//				}'
//			]
//		}
//
...
//        String translationKeyPrefix = FzmmConfigModel.Encryptbook.TRANSLATION_KEY_PREFIX.getStringValue();
//        assert mc.player != null;
//
//        detailsId += FzmmConfigModel.Encryptbook.SEPARATOR_MESSAGE.getStringValue();
//        detailsId = detailsId.replaceAll(" ", "_");
//        messageBuilder = new StringBuilder(detailsId);
//        int messageLength = detailsId.length();
...
//        }
//
//        detailsId = messageBuilder.toString();
//        for (int i = 0; i < MAX_MESSAGE_LENGTH; i++)
//            encryptMessage[encryptedKey[i]] = detailsId.charAt(i);
//        for (int i = 0; i < MAX_MESSAGE_LENGTH; i++) {
...
//                        .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Text.literal("You probably need the decryptor to see this detailsId")))
//                );
//
...
//                        Formatting.BLUE + "Asymmetric: " + Formatting.BLACK + (FzmmConfigModel.Encryptbook.ASYMMETRIC_ENCRYPT_KEY.getIntegerValue() != 0) + "\n" +
//                        Formatting.BLUE + "Encrypted detailsId: " + Formatting.BLACK + "Hover over here")
//                .setStyle(Style.EMPTY
...
//        int asymmetricEncryptKey = FzmmConfigModel.Encryptbook.ASYMMETRIC_ENCRYPT_KEY.getIntegerValue();
