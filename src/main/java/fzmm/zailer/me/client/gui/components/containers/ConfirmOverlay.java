...
public class ConfirmOverlay extends OverlayContainer<EFlowLayout> {
    ...
    public ConfirmOverlay(Component question, Consumer<Boolean> onConfirm) {
    ...
    protected void addComponents(Component question, Consumer<Boolean> onConfirm) {
        ...
        buttonLayout.child(UIComponents.button(Component.translatable("fzmm.gui.confirmDialog.confirm"), buttonComponent -> {
                    onConfirm.accept(true);
                    this.remove();
                }).positioning(Positioning.relative(0, 0))
                .horizontalSizing(Sizing.fixed(100)));

        buttonLayout.child(UIComponents.button(Component.translatable("fzmm.gui.confirmDialog.cancel"), buttonComponent -> {
