...
public class CoordinatesScreen extends ConvertersBaseScreen {
	...
	protected void init() {
		...
		this.children.add(this.netherXNumberField);
		this.children.add(this.netherZNumberField);
		this.children.add(this.overworldXNumberField);
		this.children.add(this.overworldZNumberField);
	}
