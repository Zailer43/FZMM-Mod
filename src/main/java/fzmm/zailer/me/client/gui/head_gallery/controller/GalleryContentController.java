...
public class GalleryContentController extends AbstractGalleryContent implements IMemento {
    ...
    public void configureComponent(EFlowLayout rootComponent) {
        ...
        this.scaleSlider.message(s -> Text.translatable("fzmm.gui.headGallery.option.itemScale", s));
    ...
    public void setPage(int page) {
        ...
        MinecraftClient.getInstance().execute(() -> this.contentScroll.configure(component -> {
