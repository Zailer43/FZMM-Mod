...
//
//		this.detailsId = new ConfigString("detailsId", "Hello world", this.commentBase + "detailsId");
...
//		String detailsId = this.detailsId.getStringValue();
//		if (detailsId.length() < 2) {
...
//		GradientLogic gradient = new GradientLogic(detailsId, obfuscated, bold, strikethrough, underline, italic);
//
...
//					if (handItemIsEmpty) {
//						ItemStack stack = new DisplayUtils(FzmmConfigModel.getConfigItem(FzmmConfigModel.Generic.DEFAULT_GRADIENT_ITEM))
//								.addLore(gradient)
//								.get();
