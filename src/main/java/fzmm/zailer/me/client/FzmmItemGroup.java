...
//                    stacks.add(new BlockStateTagItem(Items.MANGROVE_PROPAGULE, "Mangrove propagule on the floor").add("hanging", false).get());
                    ...
                    entries.accept(new BlockStateItemBuilder(Items.POTENT_SULFUR, "potentSulfurErupting").add("potent_sulfur_state", "erupting").get());
                    entries.accept(new BlockStateItemBuilder(Items.POTENT_SULFUR, "potentSulfurContinuous").add("potent_sulfur_state", "continuous").get());
