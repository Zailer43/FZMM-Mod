...
public class TestCommands {
    ...
    public static void registerCommands(CommandDispatcher<FabricClientCommandSource> dispatcher, CommandBuildContext registryAccess) {
        var testCommand = ClientCommands.literal("fzmm:test");

        testCommand.then(ClientCommands.literal("head_generator:write")
                .executes(ctx -> {
        ...
        testCommand.then(ClientCommands.literal("snack_bar:timer")
                .executes(ctx -> {
        ...
        testCommand.then(ClientCommands.literal("snack_bar:color")
                .executes(ctx -> {
        ...
        testCommand.then(ClientCommands.literal("snack_bar:button")
                .executes(ctx -> {
        ...
        testCommand.then(ClientCommands.literal("parity_component")
                .executes(ctx -> {
